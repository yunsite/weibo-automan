/*
 * Copyright (C) 2010 Cyril Mottier (http://www.cyrilmottier.com) Licensed under the Apache License, Version 2.0 (the
...
/**
 * Abstraction of a {@link QuickAction} wrapper. A QuickActionWidget is displayed on top of the user interface (it
 * overlaps all UI elements but the notification bar). Clients may listen to user actions using a
...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    public static interface OnQuickActionClickListener {
        ...
        /**
         * Clients may implement this method to be notified of a click on a particular quick action.
         * 
    ...
    /**
     * Equivalent to {@link PopupWindow#setContentView(View)} but with a layout identifier.
     * 
    ...
    /**
     * Sets the arrow offset to a new value. Setting an arrow offset may be particular useful to warn which view the
     * QuickActionWidget is related to. By setting a positive offset, the arrow will overlap the view given by
    ...
    /**
     * By default, a {@link QuickActionWidget} is dismissed once the user clicked on a {@link QuickAction}. This
     * behavior can be changed using this method.
     * 
     * @param dismissOnClick True if you want the {@link QuickActionWidget} to be dismissed on click else false.
     */
    ...
    /**
     * Add a new QuickAction to this {@link QuickActionWidget}. Adding a new {@link QuickAction} while the
     * {@link QuickActionWidget} is currently being shown does nothing. The new {@link QuickAction} will be displayed on
     * the next call to {@link #show(View)}.
     * 
    ...
    /**
     * Call that method to display the {@link QuickActionWidget} anchored to the given view.
     * 
    ...
    private void prepareAnimationStyle() {
        ...
        if (arrowPointX <= screenWidth / 4) {
            ...
            setAnimationStyle(onTop ? R.style.GreenDroid_Animation_PopUp_Center : R.style.GreenDroid_Animation_PopDown_Center);
        }
    }
